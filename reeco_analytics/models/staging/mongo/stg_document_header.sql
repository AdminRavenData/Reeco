...
select 
    ...
    JSON_EXTRACT_PATH_TEXT(TOTALPRODUCTSPRICE, 'Value')::FLOAT AS TOTAL_PRODUCT_PRICE,
    JSON_EXTRACT_PATH_TEXT(TOTALAMOUNT, 'Value')::FLOAT AS TOTAL_AMOUNT,
    JSON_EXTRACT_PATH_TEXT(TOTALDISCOUNT, 'Value')::FLOAT AS TOTAL_DISCOUNT_PRICE,
    JSON_EXTRACT_PATH_TEXT(TOTALTAX, 'Value')::FLOAT AS TOTAL_TAX,
    JSON_EXTRACT_PATH_TEXT(TOTALSHIPPING, 'Value')::FLOAT AS TOTAL_SHIPPING,
